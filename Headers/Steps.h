	...
	for(int v = 0;  v < N; v++){
			...
			k = MovedParticle.cell;
				...
				if(randP != newvv && !Config.part[newvv].already){ 
					...
					if (R[0] > Config.l_2[0] || R[0] < -Config.l_2[0])  std::cout << "PPb(" << R[0] << " " << Config.l_2[0] << ")" <<  std::endl;
					if (R[1] > Config.l_2[1] || R[1] < -Config.l_2[1])  std::cout << "PPb(" << R[1] << " " << Config.l_2[1] << ")" <<  std::endl;
					if (R[2] > Config.l_2[2] || R[2] < -Config.l_2[2])  std::cout << "PPb(" << R[2] << " " << Config.l_2[2] << ")" <<  std::endl;
					overlapPear(); 
				}
			...
			if(Config.Ns != 0 ){
				...
				while(newvv != -1 && !inside){
					...
					if (R[0] > Config.l_2[0] || R[0] < -Config.l_2[0])  std::cout << "PSb(" << R[0] << " " << Config.l_2[0] << ")" <<  std::endl;
					if (R[1] > Config.l_2[1] || R[1] < -Config.l_2[1])  std::cout << "PSb(" << R[1] << " " << Config.l_2[1] << ")" <<  std::endl;
					if (R[2] > Config.l_2[2] || R[2] < -Config.l_2[2])  std::cout << "PSb(" << R[2] << " " << Config.l_2[2] << ")" <<  std::endl;
			...
			if( MovedParticle.cellN != MovedParticle.cell && !inside){
				...
				while(vv != -1 && !inside){
					...
					if(randP != newvv && !Config.part[newvv].already){ 
						...
						if (R[0] > Config.l_2[0] || R[0] < -Config.l_2[0])  std::cout << "PPt(" << R[0] << " " << Config.l_2[0] << ")" <<  std::endl;
						if (R[1] > Config.l_2[1] || R[1] < -Config.l_2[1])  std::cout << "PPt(" << R[1] << " " << Config.l_2[1] << ")" <<  std::endl;
						if (R[2] > Config.l_2[2] || R[2] < -Config.l_2[2])  std::cout << "PPt(" << R[2] << " " << Config.l_2[2] << ")" <<  std::endl;
						overlapPear(); 
					}
				...
				if(Config.Ns != 0 ){
					...
					while(newvv != -1 && !inside){
						...
						if (R[0] > Config.l_2[0] || R[0] < -Config.l_2[0])  std::cout << "PSt(" << R[0] << " " << Config.l_2[0] << ")" <<  std::endl;
						if (R[1] > Config.l_2[1] || R[1] < -Config.l_2[1])  std::cout << "PSt(" << R[1] << " " << Config.l_2[1] << ")" <<  std::endl;
						if (R[2] > Config.l_2[2] || R[2] < -Config.l_2[2])  std::cout << "PSt(" << R[2] << " " << Config.l_2[2] << ")" <<  std::endl;
						overlapPearSphere(); 
						newvv = Config.linkP[newvv];
					}
				}
						...
						for (int iz=0; iz < 3 && !inside; iz++){
							...
							while(vv != -1 && !inside){
								...
								if(!Config.part[newvv].already){ 
									...
									if (R[2] > Config.l_2[2] || R[2] < -Config.l_2[2])  std::cout << "PPb(" << sx[ix] << "," << sy[iy] << ") (" << sx[0] << "," << sy[0] << ") " << R[2] << " " << Config.l_2[2] << " (" << by[iy] << ",1," << lb[2] << " )" <<std::endl;
							...
							if(Config.Ns != 0 ){
								...
								while(newvv != -1 && !inside){
									...
									if (R[2] > Config.l_2[2] || R[2] < -Config.l_2[2]) std::cout << "PSb(" << sy[iy] << ") (" << sy[2] << ") " << R[2] << " " << Config.l[2] << " (" << MovedParticle.pos[2] << "," <<  Config.part[newvv].pos[2] << "," << sy[iy]*Config.wP[2] << "," << Config.wP[0] << ")" << std::endl;
									overlapPearSphere(); 
									newvv = Config.linkP[newvv];
								}
							}
							...
							for (int iz=0; iz < 3 && !inside; iz++){
								...
								while(vv != -1 && !inside){
									...
									if(!Config.part[newvv].already){ 
										...
										if (R[2] > Config.l_2[2] || R[2] < -Config.l_2[2])  std::cout << "PPt(" << sxN[ix] << "," << syN[iy] << ") (" << sxN[0] << "," << syN[0] << ") " << R[2] << " " << Config.l_2[2] << " (" << by[iy] << ",1," << lb[2] << " )" <<std::endl;
										overlapPear(); 
									}
									vv = Config.linkP[vv];
								}
								if(Config.Ns != 0 ){
									...
									while(newvv != -1 && !inside){
										...
										if (R[2] > Config.l_2[2] || R[2] < -Config.l_2[2])  std::cout << "PSt(" << sxN[ix] << "," << syN[iy] << ") (" << sxN[0] << "," << syN[0] << ") " << R[2] << " " << Config.l_2[2] << " (" << by[iy] << ",1," << lb[2] << " )" << randP << " " << newvv << std::endl;
										overlapPearSphere(); 
										newvv = Config.linkP[newvv];
									}
								}
			...
			if(!inside ){
				...
				while(vv != -1 && !inside){
					...
					if(!Config.part[newvv].already){ 
						...
						if (R[0] > Config.l_2[0] || R[0] < -Config.l_2[0])  std::cout << "SP(" << R[0] << " " << Config.l_2[0] << ") (" << MovedParticle.pos[0] << "," << Config.part[newvv].pos[0] << ")" << std::endl;
						if (R[1] > Config.l_2[1] || R[1] < -Config.l_2[1])  std::cout << "SP(" << R[1] << " " << Config.l_2[1] << ") (" << MovedParticle.pos[1] << "," << Config.part[newvv].pos[1] << ")" << std::endl;
						if (R[2] > Config.l_2[2] || R[2] < -Config.l_2[2])  std::cout << "SP(" << R[2] << " " << Config.l_2[2] << ") (" << MovedParticle.pos[2] << "," << Config.part[newvv].pos[2] << ")" << std::endl;
						overlapSpherePear(); 
					}
							...
							for (int iz=0; iz < 3 && !inside; iz++){
								...
								while(vv != -1 && !inside){
									...
									if(!Config.part[newvv].already){ 
										...
										if (R[2] > Config.l_2[2] || R[2] < -Config.l_2[2])  std::cout << "SP(" << sxN[ix] << "," << syN[iy] << ") (" << sxN[0] << "," << syN[0] << ") " << R[2] << " " << Config.l_2[2] << " (" << by[iy] << ",1," << lb[2] << "," << MovedParticle.pos[0] << "," << Config.part[newvv].pos[2] << ")" <<std::endl;
					...
					for (int iy=0; iy < 5 && !inside; iy++){
						for (int iz=0; iz < 5 && !inside; iz++){
							...
							if(vv != -1){
								...
								if (R[0] > Config.l_2[0] || R[0] < -Config.l_2[0])  std::cout << "SS(" << sx[ix] << "," << sy[iy] << ") (" << sx[0] << "," << sy[0] << ") (" << bx[ix] << ",0," << lb[0] << ") (" << MovedParticle.pos[0] << "," << MovedParticle.pos[1] << ") (" << Config.part[vv].pos[0] << "," << Config.part[vv].pos[1] << ") " << k << " " << Config.part[vv].cell << std::endl;
								if (R[1] > Config.l_2[1] || R[1] < -Config.l_2[1])  std::cout << "S(" << sx[ix] << "," << sy[iy] << ") (" << sx[0] << "," << sy[0] << ") (" << bx[ix] << ",0," << lb[0] << ") (" << MovedParticle.pos[0] << "," << MovedParticle.pos[1] << ") (" << Config.part[vv].pos[0] << "," << Config.part[vv].pos[1] << ") " << k << " " << Config.part[vv].cell << std::endl;
								if (R[2] > Config.l_2[2] || R[2] < -Config.l_2[2])  std::cout << "S(" << sx[ix] << "," << sy[iy] << ") (" << sx[0] << "," << sy[0] << ") (" << bx[ix] << ",0," << lb[0] << ") (" << MovedParticle.pos[0] << "," << MovedParticle.pos[2] << ") (" << Config.part[vv].pos[0] << "," << Config.part[vv].pos[2] << ") " << k << " " << Config.part[vv].cell << std::endl;
								overlapSphere(); 
							}
						}
					}
...
void Compression_step(){	
	...
	MovedParticle=Config.part[v];
		...
		if(!inside){
			...
			dsx = MovedParticle.pos[0]-distN*MovedParticle.ori[0];

			dsy = MovedParticle.pos[1]-distN*MovedParticle.ori[1];


			dsz = MovedParticle.pos[2]-distN*MovedParticle.ori[2];
			if(dsx < 0){
				sx[0] = Config.WP[0]-1;
				sx[1] = sx[0] -1;
				sx[2] = 0;
		...
		if(!inside){
			dsxN = MovedParticle.pos[0]+distN*MovedParticle.ori[0];

			dsyN = MovedParticle.pos[1]+distN*MovedParticle.ori[1];

			dszN = MovedParticle.pos[2]+distN*MovedParticle.ori[2];
						...
						while(vv != -1 && !inside){
							...
							if(!Config.part[newvv].already){ 
								...
								if (R[2] > Config.l_2[2])  R[2] -= Config.l[2];
									...
									if (R[0] > Config.l_2[0] || R[0] < -Config.l_2[0])  std::cout << "(" << sxN[ix] << "," << syN[iy] << ") (" << sxN[0] << "," << syN[0] << ") " << R[0] << " " << Config.l_2[0] << " (" << bx[ix] << ",0," << lb[0] << " )" << std::endl;
									if (R[1] > Config.l_2[1] || R[1] < -Config.l_2[1])  std::cout << "(" << sxN[ix] << "," << syN[iy] << ") (" << sxN[0] << "," << syN[0] << ") " << R[1] << " " << Config.l_2[1] << " (" << by[iy] << ",1," << lb[1] << " )" <<std::endl;
								overlapSpherePear(); 
							}
							vv = Config.linkP[vv];
						}
